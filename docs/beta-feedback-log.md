...
| BETA-004 | P2 | UI | Fixed | Stage 9 HTML prototype should mention RC readiness and beta fixes. | Open `ui-preview/index.html`. | Stage 9 prototype commit | Verified title, sidebar, backup summary, and draft expiry copy. |
